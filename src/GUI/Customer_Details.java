...
public class Customer_Details implements ActionListener {
    ...
    private JButton SearchID_Button, SearchName_Button, Update_Button, Add_Button, Remove_Button, Book_Button, Unbook_Button, Back_Button, Logout_Button, ClearBill_Button;
    ...
    public Customer_Details() {
        ...
        MainPanel.setSize(new Dimension(1366, 730));
        MainPanel.setBounds(0, 0, 1366, 730);
...
//        jScrollPane1.setViewportView(jTable1);
        ...
        MainPanel.add(jScrollPane1, new AbsoluteConstraints(10, 50, 1330, 560));
        ...
        bottomPanel.add(Book_Button);
        bottomPanel.add(Unbook_Button);
        bottomPanel.add(ClearBill_Button);
        bottomPanel.add(Add_Button);
        bottomPanel.add(Update_Button);
        bottomPanel.add(Remove_Button);
        bottomPanel.add(Back_Button);
        bottomPanel.add(Logout_Button);
        MainPanel.add(bottomPanel, new AbsoluteConstraints(10, 625, 1330, 45));
        ...
        Unbook_Button.addActionListener(this);
    ...
    public void actionPerformed(ActionEvent e) {
        switch (e.getActionCommand()) {
            ...
            case "Back": {
                ...
                Parent_JFrame.getMainFrame().getContentPane().invalidate();
                Parent_JFrame.getMainFrame().getContentPane().revalidate();
                Parent_JFrame.getMainFrame().repaint();
            }
            break;
            case "Logout": {
