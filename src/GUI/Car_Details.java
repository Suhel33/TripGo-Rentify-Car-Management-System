...
public class Car_Details {
    ...
    private static JButton SearchName_Button, SearchRegNo_Button, Add_Button,
            Update_Button, Remove_Button, Book_Button, Unbook_Button, BackButton, LogoutButton;
...
//ID,  Maker,  Name,  Colour,  Type,  SeatingCapacity,  Model,  Condition,  RegNo, RentPerHour,  IsRented RentDate, carOwner customer
        ...
        String[] columns = {"Sr#", "ID", "Maker", "Name", "Colour", "Type", "Seats", "Model", "Condition",
            "Reg No.", "Rent/hour", "Car Owner", "Customer"};
...
//RentPerHour,  IsRented RentDate, carOwner customer
        ...
        jTable1.getColumnModel().getColumn(12).setMinWidth(220);
        ...
        MainPanel.add(jScrollPane1, new AbsoluteConstraints(10, 60, 1330, 560));
        ...
        MainPanel.add(bottomPanel, new AbsoluteConstraints(10, 625, 1330, 50));
        ...
        Book_Button.addActionListener(new Car_Details_ActionListener());
        Unbook_Button.addActionListener(new Car_Details_ActionListener());
