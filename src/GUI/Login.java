...
public class Login {
    ...
    public Login() {
        ...
        Image_jLabel.setIcon(ResourceHelper.getImageIcon("LoginImage.jpg"));
    ...
    private class LoginActionListener implements ActionListener {
        ...
        public void actionPerformed(ActionEvent e) {
            switch (e.getActionCommand()) {
                ...
                case "Login": {
                    if (UN_TextField.getText().trim().equalsIgnoreCase("suhel@admin")
                            && String.valueOf(Password_Field.getPassword()).equals("123456")) {
